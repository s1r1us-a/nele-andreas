...
export const EXPEDITIONS = [
  ...
  { key:'30',  label:'30 Minuten', short:'30 Min', ms:30*60*1000,   boost:0.6, icon:'🏞️' },
  { key:'60',  label:'1 Stunde',   short:'1 Std',  ms:60*60*1000,   boost:1.1, icon:'🗻' },
  { key:'180', label:'3 Stunden',  short:'3 Std',  ms:180*60*1000,  boost:2.2, icon:'🌋' },
  { key:'480', label:'8 Stunden',  short:'8 Std',  ms:480*60*1000,  boost:3.5, icon:'🌌' },
];
