...
export const CLASSES = [
  { id:'heiler',      label:'Heiler',      icon:'✨',
    ...
    pros:['Stärkste Heilung (×1,6 Heilwirkung)','Magischer Fernkampf','Sehr robust – kämpft lange durch','Top-Stütze im Koop-Turm'],
    cons:['Geringster Schaden (×0,65)','Nur Stoff & Zauberstab tragbar'],
  ...
  { id:'kaempfer',    label:'Kämpfer',     icon:'⚔️',
    ...
    pros:['Höchster Grundschaden (×1,0)','Ausgewogen & anfängerfreundlich','Raserei: +100 % Krit-Chance (7 s)'],
    cons:['Keine eigene Heilung','Nur Stoff & Leder – keine Platte'],
  ...
  { id:'verteidiger', label:'Verteidiger', icon:'🛡️',
    ...
    pros:['Trägt als Einziger Plattenrüstung','Höchste Rüstung & Überlebenskraft','Schildwall: −80 % erlittener Schaden (10 s)','Bester Frontkämpfer im Koop-Turm'],
    cons:['Niedriger Schaden (×0,7)','Lange Kämpfe'],
  ...
  { id:'hexer',       label:'Hexer',       icon:'🔮',
    ...
    pros:['Magischer Schaden mit Lebensraub','Heilt sich selbst (×1,5 Heilwirkung)','Seelenraub: 200 % Schaden + Selbstheilung'],
    cons:['Sehr zerbrechlich – nur Stoff','Mittlerer Schaden (×0,8)'],
    allowedMaterials:['stoff','zauberstab'],      damageSchool:'magisch',
